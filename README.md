...
{This web application acts an asset tracker for IT assets. I work in IT and we often run into problems keeping
track of all of the various items we have. This is handled with a mongodb database that has 2 tables. An assets table
